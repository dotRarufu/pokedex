...
<nav
  class="lg:mx-0 bg-primary-500 sm:p-0 sm:max-w-[20.75rem] rounded-t-[16px] sm:mx-auto sm:my-[1.5rem] p-[1rem] sm:bg-transparent lg:sticky top-0 lg:z-[3] lg:rounded-none"
>
  <ul
